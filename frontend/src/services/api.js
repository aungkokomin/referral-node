...
export const api = {
  ...
  getCommissionSettings: () => apiCall('/commission-settings'),
  createCommissionSetting: (data) => apiCall('/commission-settings', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  updateCommissionSetting: (id, data) => apiCall(`/commission-settings/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  deleteCommissionSetting: (id) => apiCall(`/commission-settings/${id}`, {
    method: 'DELETE',
  }),
};
